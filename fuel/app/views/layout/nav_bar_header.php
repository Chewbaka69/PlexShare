<div class="nav-bar">
    ...
    <ul class="nav nav-bar-nav nav-bar-right">
        <li class="">
            <a class="activity-btn" href="#" title="" data-toggle="tooltip" data-placement="bottom"
               title="Status">
        ...
        <li>
            <a class="settings-btn dropdown-poster-container" href="/settings" title="" data-toggle="tooltip"
        ...
        <li id="nav-dropdown" class="nav-dropdown dropdown">
            ...
            <ul class="dropdown-menu signed-in full-user">
                ...
                <li class="signed-in-item"><a href="#">Account</a></li>
                <li class="divider"></li>
                <?php if ($user->admin) : ?>
                    <li class="signed-in-item full-user-item">
                        <a class="admin-user-btn" href="/admin">Admin
                            <span class="badge">0</span>
                        </a>
                    </li>
                    <li class="signed-in-item">
                        <a class="users-btn" href="/admin/users">Users
                            <span class="media-count-badge badge">0</span>
                        </a>
                    </li>
                    <li class="divider"></li>
                    <li class="signed-in-item switch-user-item">
                        <a class="switch-user-btn" href="#">Switch User...</a>
                    </li>
                <?php endif; ?>
